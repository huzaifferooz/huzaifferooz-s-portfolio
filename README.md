...
- `components/visuals/`: the project card visuals (one per project id).
- `components/Projects.tsx`: pinned horizontal scroll with 3D-tilt cards (a single project shows as one centered card).
